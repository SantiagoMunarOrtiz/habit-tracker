  ...
  return (
    <div className="bg-[#121212] text-gray-200 p-8 min-h-screen font-sans overflow-x-auto">
      ...
      <div className="min-w-[1200px] border border-[#333] bg-[#1a1a1a] shadow-xl mx-auto p-4 flex flex-col gap-6 rounded-xl">
        ...
        {/* Header */}
        <div className="bg-[#2a2a2a] border border-[#444] rounded py-3 tracking-[0.3em] font-bold text-gray-300 text-xl flex justify-between items-center px-8">
          <button onClick={handlePrevMonth} className="text-gray-500 hover:text-white transition-colors p-2">&lt;</button>
          <span>{monthNames[currentMonth]} {currentYear}</span>
          <button onClick={handleNextMonth} className="text-gray-500 hover:text-white transition-colors p-2">&gt;</button>
        </div>
            ...
            <div className="flex-1 overflow-x-auto flex flex-col">
              ...
              <div className="h-16 flex border-b border-[#333] bg-[#1a1a1a]">
                {Array.from({ length: 31 }).map((_, i) => {
                  ...
                  if (!day) {
                    return (
                      <div key={i} className="flex-1 min-w-[28px] border-r border-[#333] flex flex-col items-center justify-center text-[10px] text-gray-600 bg-[#151515] opacity-50">
                        <div className="border-b border-[#333] w-full text-center py-1 bg-[#1a1a1a]">-</div>
                ...
                return (
                  <div key={i} className="h-10 flex border-b border-[#333] border-dotted bg-[#1a1a1a]">
                    {Array.from({ length: 31 }).map((_, j) => {
                      ...
                      if (!day) {
                        return <div key={j} className="flex-1 min-w-[28px] border-r border-[#333] border-dotted bg-[#151515] opacity-50"></div>;
                      }
              ...
              <div className="h-8 flex border-b border-[#333] bg-[#222]">
                {Array.from({ length: 31 }).map((_, i) => {
                  ...
                  if (!t) return <div key={i} className="flex-1 min-w-[28px] border-r border-[#333] bg-[#151515] opacity-50"></div>;
                  return (
              ...
              <div className="h-8 flex bg-[#1a1a1a]">
                {Array.from({ length: 31 }).map((_, i) => {
                  const p = dailyPercents[i];
                  if (p === undefined) return <div key={i} className="flex-1 min-w-[28px] border-r border-[#333] bg-[#151515] opacity-50"></div>;
                  return (
