import { Check, Trash2, Palmtree, X } from 'lucide-react';
          ...
          <div className="w-64 flex flex-col border-r border-[#333]">
            ...
            {paddedDaily.map((h, i) => (
              <div key={i} className="h-10 border-b border-[#333] border-dotted flex items-center px-3 text-xs justify-between text-gray-300 bg-[#1a1a1a] group">
                ...
                {h && (
                   <button onClick={() => onArchive(h.id)} className="opacity-0 group-hover:opacity-100 text-gray-500 hover:text-red-500 transition-opacity">
